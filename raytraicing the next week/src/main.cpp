        ...
        for (int b = -11; b < 11; b++) {
            ...
            if ((center - point3(4, 0.2, 0)).length() > 0.9) {
                ...
                if (choose_mat < 0.8) {
                    ...
                    world.add(make_shared<sphere>(center,center_2, 0.2, sphere_material));
...
int main(){
    const unsigned int SCENE_NB = 2;

    switch (SCENE_NB)
    {
        case 0: bouncing_spheres(); break;
        case 1: checker_spheres(); break;
        case 2: earth_sphere(); break;

        default: 
            std::clog << SCENE_NB << " is not a valid scene nb\n";
    }
    return 0;
}